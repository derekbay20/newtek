...
$wp_customize->add_panel(
	...
	array(
		...
		'theme_supports' => '',
		'title'          => esc_html__('Template Options', 'slain'),
		'description'    => esc_html__('Templates related settings and sections goes here. You can manage different templates like page, post, 404page etc from this panel.', 'slain'),
	)
);
