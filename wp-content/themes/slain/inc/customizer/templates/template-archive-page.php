...
$wp_customize->add_control( 
	new Slain_Toggle_Switch_Custom_control(
		...
		array(
			...
			'description' => esc_html__( 'Checked to enable full width for first post on archive page.', 'slain' ),
			'section'  => 'template_archive_options',
			'priority' => 20
		)
	)
...
$wp_customize->add_setting(
	'slain_enable_drop_caps_archive',
	array(
		'default'		=> 'disable',
		'sanitize_callback'		=> 'centurylib_sanitize_select'
	),
...
$wp_customize->add_control(
	new Centurylib_Customize_Switch_Control(
		...
		array(
            ...
            'description' => esc_html__( 'Enable to show drop caps on your archive page and disable it to show normal post.', 'slain' )
		)
	)
);

$wp_customize->add_setting(
	'slain_enable_comment_count_archive',
	array(
		'default'		=> 'show',
		'sanitize_callback'		=> 'centurylib_sanitize_select'
	),
...
$wp_customize->add_setting(
	'slain_post_description_archive',
	array(
		'default'		=> 'excerpt',
		'sanitize_callback'		=> 'centurylib_sanitize_select'
	),
...
$wp_customize->add_setting(
	'slain_pagination_layout_archive',
	array(
		'default'		=> 'default',
		'sanitize_callback'		=> 'centurylib_sanitize_select'
	),
...
$wp_customize->selective_refresh->add_partial( 
	...
	array(
		...
		'render_callback' => 'slain_customize_partial_archive_more',
	)
);
