<?php
/**
 * Slain Customizer Custom Controls
 *
 */
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Slain_Custom_Control extends WP_Customize_Control {
		protected function get_slain_resource_url() {
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Custom_Section extends WP_Customize_Section {
		protected function get_slain_resource_url() {
			if( strpos( wp_normalize_path( __DIR__ ), wp_normalize_path( WP_PLUGIN_DIR ) ) === 0 ) {
				// We're in a plugin directory and need to determine the url accordingly.
				return plugin_dir_url( __DIR__ );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Image_Checkbox_Custom_Control extends Slain_Custom_Control {
		/**
		...
		public function enqueue() {
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.0', 'all' );
		}
		/**
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Text_Radio_Button_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Image_Radio_Button_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Single_Accordion_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'slain-custom-controls-js', $this->get_slain_resource_url() . 'assets/js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Simple_Notice_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Slider_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'slain-custom-controls-js', $this->get_slain_resource_url() . 'assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.0', true );
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Toggle_Switch_Custom_control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Sortable_Repeater_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Dropdown_Select2_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'slain-select2-js', $this->get_slain_resource_url() . 'assets/vendor/select2/js/select2.full.min.js', array( 'jquery' ), '4.0.13', true );
			wp_enqueue_script( 'slain-custom-controls-js', $this->get_slain_resource_url() . 'assets/js/customizer.js', array( 'slain-select2-js' ), '1.0', true );
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.1', 'all' );
			wp_enqueue_style( 'slain-select2-css', $this->get_slain_resource_url() . 'assets/vendor/select2/css/select2.min.css', array(), '4.0.13', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Dropdown_Posts_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_TinyMCE_Custom_control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['Slaintinymcetoolbar1'] = isset( $this->input_attrs['toolbar1'] ) ? esc_attr( $this->input_attrs['toolbar1'] ) : 'bold italic bullist numlist alignleft aligncenter alignright link';
			$this->json['Slaintinymcetoolbar2'] = isset( $this->input_attrs['toolbar2'] ) ? esc_attr( $this->input_attrs['toolbar2'] ) : '';
			$this->json['Slainmediabuttons'] = isset( $this->input_attrs['mediaButtons'] ) && ( $this->input_attrs['mediaButtons'] === true ) ? true : false;
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Google_Font_Select_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function __construct( $manager, $id, $args = array(), $options = array() ) {
			...
			$this->fontList = $this->slain_getGoogleFonts( 'all' );
			// Decode the default json font value
			$this->fontValues = json_decode( $this->value() );
			// Find the index of our default font within our list of Google fonts
			$this->fontListIndex = $this->slain_getFontIndex( $this->fontList, $this->fontValues->font );
		}
		/**
		 * Enqueue our scripts and styles
		 */
		...
		public function to_json() {
			parent::to_json();
			$this->json['slainFontList'] = $this->fontList;
		}
		/**
		 * Render the control in the customizer
		 */
		public function render_content() {
			...
			if( !empty($this->fontList) ) {
				...
				<div class="google_fonts_select_control">
					...
					<div class="customize-control-description hidden"><?php esc_html_e( 'Select weight & style for regular text', 'slain' ) ?></div>
					<div class="weight-style hidden">
					...
					<div class="customize-control-description hidden"><?php esc_html_e( 'Select weight for', 'slain' ) ?> <italic><?php esc_html_e( 'italic text', 'slain' ) ?></italic></div>
					<div class="weight-style hidden">
					...
					<div class="customize-control-description hidden"><?php esc_html_e( 'Select weight for', 'slain' ) ?> <strong><?php esc_html_e( 'bold text', 'slain' ) ?></strong></div>
					<div class="weight-style">
						<select class="google-fonts-boldweight-style hidden">
							<?php
							$optionCount = 0;
							foreach( $this->fontList[$this->fontListIndex]->variants as $key => $value ) {
		 ...
		 */
		public function slain_getFontIndex( $haystack, $needle ) {
			if(!$haystack){
				return false;
			}
		 ...
		 */
		public function slain_getGoogleFonts( $count = 30 ) {
			// Google Fonts json generated from https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=YOUR-API-KEY
			$fontFile = $this->get_slain_resource_url() . 'assets/data/google-fonts-alphabetical.json';
			
			if ( $this->fontOrderBy === 'popular' ) {
				$fontFile = $this->get_slain_resource_url() . 'assets/data/google-fonts-popularity.json';
			}

			$fontFile = apply_filters( 'slain_font_file_json_url', $fontFile, $this->fontOrderBy );
	 ...
	 */
	class Slain_Customize_Alpha_Color_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'slain-custom-controls-js', $this->get_slain_resource_url() . 'assets/js/customizer.js', array( 'jquery', 'wp-color-picker' ), '1.0', true );
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array( 'wp-color-picker' ), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
		 */
	 ...
	 */
	class Slain_Alpha_Color_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		...
		public function enqueue() {
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.0', 'all' );
			wp_enqueue_script( 'wp-color-picker-alpha', $this->get_slain_resource_url() . 'assets/vendor/alpha/js/wp-color-picker-alpha.js', array( 'wp-color-picker' ), '1.0', true );
	 ...
	 * @link https://github.com/maddisondesigns
	 */
	class Slain_Pill_Checkbox_Custom_Control extends Slain_Custom_Control {
		/**
		 * The type of control being rendered
		 */
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'slain-custom-controls-js', $this->get_slain_resource_url() . 'assets/js/customizer.js', array( 'jquery', 'jquery-ui-core' ), '1.1', true );
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.0', 'all' );
		}
		/**
		 * Render the control in the customizer
	 ...
	 *
	 */
	class Slain_Upsell_Section extends Slain_Custom_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'slain-upsell';
		/**
		 * The Upsell URL
		 */
		public $url = '';
		 ...
		 */
		public function enqueue() {
			wp_enqueue_script( 'slain-custom-controls-js', $this->get_slain_resource_url() . 'js/customizer.js', array( 'jquery' ), '1.0', true );
			wp_enqueue_style( 'slain-custom-controls-css', $this->get_slain_resource_url() . 'assets/css/customizer.min.css', array(), '1.0', 'all' );
		}
		/**
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="slain_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
	 ...
	 */
	if ( ! function_exists( 'slain_url_sanitization' ) ) {
		function slain_url_sanitization( $input ) {
	 ...
	 */
	if ( ! function_exists( 'slain_switch_sanitization' ) ) {
		function slain_switch_sanitization( $input ) {
			if ( true === $input ) {
				return 1;
			} else {
				return 0;
	 ...
	 * @return integer	Sanitized value
	 */
	if ( ! function_exists( 'slain_radio_sanitization' ) ) {
		function slain_radio_sanitization( $input, $setting ) {
	 ...
	 */
	if ( ! function_exists( 'slain_sanitize_integer' ) ) {
		function slain_sanitize_integer( $input ) {
			return (int) $input;
		}
	}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'slain_text_sanitization' ) ) {
		function slain_text_sanitization( $input ) {
			if ( strpos( $input, ',' ) !== false) {
				$input = explode( ',', $input );
			}
			if( is_array( $input ) ) {
	 ...
	 */
	if ( ! function_exists( 'slain_array_sanitization' ) ) {
		function slain_array_sanitization( $input ) {
			if( is_array( $input ) ) {
				foreach ( $input as $key => $value ) {
					$input[$key] = sanitize_text_field( $value );
				}
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'slain_hex_rgba_sanitization' ) ) {
		function slain_hex_rgba_sanitization( $input, $setting ) {
			...
			if ( false === strpos( $input, 'rgba' ) ) {
				...
				$input = 'rgba(' . slain_in_range( $red, 0, 255 ) . ',' . slain_in_range( $green, 0, 255 ) . ',' . slain_in_range( $blue, 0, 255 ) . ',' . slain_in_range( $alpha, 0, 1 ) . ')';
			}
			return $input;
		}
	}
	 ...
	 */
	if ( ! function_exists( 'slain_in_range' ) ) {
		function slain_in_range( $input, $min, $max ){
			if ( $input < $min ) {
				$input = $min;
			}
			if ( $input > $max ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'slain_google_font_sanitization' ) ) {
		function slain_google_font_sanitization( $input ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'slain_date_time_sanitization' ) ) {
		function slain_date_time_sanitization( $input, $setting ) {
	 ...
	 * @return string	Sanitized input
	 */
	if ( ! function_exists( 'slain_range_sanitization' ) ) {
		function slain_range_sanitization( $input, $setting ) {
			...
			return slain_in_range( $number, $min, $max );
		}
	}
